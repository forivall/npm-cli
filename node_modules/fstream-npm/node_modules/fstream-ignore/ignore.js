...
function IgnoreReader (props) {
  ...
  log.verbose(this.constructor.name, this instanceof IgnoreReader)
  this.on("entries", function () {
    ...
    log.verbose('entries', this.entries, hasIg)
...
IgnoreReader.prototype.addIgnoreFiles = function () {
  ...
  log.verbose('addIgnoreFiles', newIg, this.entries, this.ignoreFiles)
...
IgnoreReader.prototype.isIgnoreFile = function (e) {
  log.verbose('isIgnoreFile', e, this.ignoreFiles)
  return e !== "." &&
         e !== ".." &&
...
IgnoreReader.prototype.filterEntries = function () {
  ...
  // what it is.
  log.verbose('filterEntries', this.entries, this.constructor.name)
